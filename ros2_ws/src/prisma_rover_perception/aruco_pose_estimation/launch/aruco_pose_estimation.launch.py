...
def generate_launch_description():
    ...
    node_key = next((k for k in config.keys() if "aruco_node" in k), "/aruco_node")
    config = config[node_key]["ros__parameters"]
    ...
    map_frame_arg = DeclareLaunchArgument(
        name='map_frame',
        default_value=config.get('map_frame', 'map'),
    ...
    namespace_arg = DeclareLaunchArgument(
        ...
        description='Namespace for the ArUco node',
    )
